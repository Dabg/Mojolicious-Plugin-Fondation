...
# template inheritance, and the Fondation::Blog and Fondation::TemplateTest plugins.
# 
...
# 
# The configuration file (myapp.conf) sets the blog title and template message.
# 
# This application demonstrates template inheritance:
...
# Route 6: Test subdirectory template (demonstrates application override in subdirectory)
...
get '/' => sub {
    my $c = shift;
    $c->render(text => 'Welcome to Fondation Test Application. Visit /blog, /template-info, /template-subdir-info or /info');
};
